...
const Points = () => {
  ...
  useEffect(() => {
    async function loadPosition() {
      ...
      if(status !== 'granted') {
        Alert.alert('Atenção', 'Precisamos de sua permissão para obter sua localização');
        return;
      }
  ...
  function handleNavidateToDetail(id: number) {
            ...
            >
              {points.map(point => (
                <Marker 
                  ...
                  onPress={() => handleNavidateToDetail(point.id)}
                  coordinate={{
